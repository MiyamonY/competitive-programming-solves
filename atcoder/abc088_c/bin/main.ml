...
let () =
  let ls = Scanf.lines 3 "%d %d %d" Util.tuple3 in
  if List.map ((-999)++999) ~f:(fun a1 ->
         let c11, c12, c13 = List.nth ls 0 in
         let c21, c22, c23 = List.nth ls 1 in
         let c31, c32, c33 = List.nth ls 2 in
         let b1, b2, b3 = c11 - a1, c12 - a1, c13 - a1 in
         let a2, a3 = c21 - b1, c31 - b1 in
         c22 = a2 + b2 && c23 = a2 + b3  && c32 = a3 + b2 && c33 = a3 + b3
       ) |> List.exists ~f:((=) true)
